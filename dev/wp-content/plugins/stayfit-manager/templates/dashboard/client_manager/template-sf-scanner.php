<div id="p-0">
	...
	<div class="row">
	  ...
	  <div class="mt-3" style="width: 100%">
	  	...
	  	<button id="fake-scanning" role="submit" class="btn btn-primary" data-item='<?php echo json_encode(array( 
			'nonce' => wp_create_nonce( 'client_manager_monitor_add_nonce' ),
			'ean' => '1500271',
			'action' => 'sf_manager_client_manager_monitor_add'
		 ))?>' style="width:inherit;">
			Fałszywe skanowanie
		</button>
