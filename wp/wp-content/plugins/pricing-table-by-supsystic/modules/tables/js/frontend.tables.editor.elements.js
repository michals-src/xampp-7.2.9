...
function ptsElement_txt(jqueryHtml, block) {
	...
	this._editorToolbarBtns = [
		['pts_editattrs'], ['pts_fontselect'], ['pts_fontsizeselect'], ['bold', 'italic', 'strikethrough'], ['pts_link'], ['pts_tooltip'], ['forecolor']
	];
...
ptsElement_txt.prototype._init = function() {
	...
	,	menubar: false
	,	plugins: 'pts_editattrs pts_textcolor pts_link pts_fontselect pts_fontsizeselect pts_tooltip'
