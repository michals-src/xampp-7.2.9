...
It's possible with [Pricing Table WordPress plugin](https://supsystic.com/plugins/pricing-table?utm_source=wordpress&utm_medium=description&utm_campaign=pricingtable "Pricing Table WordPress plugin") by Supsystic. Choose pricing table template, edit content with pricing table builder and publish on the website.
...
* [Pricing Table Examples](https://supsystic.com/plugins/pricing-table/#examples "Pricing Table Examples")
* [Comparison Table](https://supsystic.com/comparison-example/ "Comparison Table")
* Tables [export/import](https://supsystic.com/documentation/export-pricing-table/ "Export my pricing table") 

It has never been so easy to create and manage pricing and comparison tables with table builder. Any element of the table can be customized with mouse click.
...
Check an article - [Getting started with pricing table plugin](https://supsystic.com/documentation/pricing-tables-geting-started/ "PGetting started with Pricing Table plugin")

= Pricing Table main settings and options =

[Pricing Table plugin Main settings](https://supsystic.com/documentation/pricing-tables-main-settings/ "Pricing Table plugin Main settings") - you find all options of the Pricing Tables plugin

= How to customize Pricing Table with online builder =

[Item, Row and Cell/Column builder](https://supsystic.com/documentation/pricing-tables-editors-settings/ "Pricing Table WordPress plugin online builder") will help you to configure table view
 ...
 * Hide table before it will be compiled on frontend
 * Minor issues fix
 ...
 * Fixed templates
 * Updated colorpicker Changed display mode
 * Fixed height issue
 ...
 * Fixed compability with old toggle data
 * Minor issues fix

= 1.5.3 / 31.05.2018 =
 * Added Schedule to Show/Hide special columns based  on time period
 ...
 * Fixed style for toggle radio in admin panel
